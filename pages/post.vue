  ...
  <div class="main-container">
    <div class="view">
      <div class="article-area">
        <div class="article">
          <h1 class="article-title">{{ data.data[1].title }}</h1>
          <div class="author-info-block">
            <NuxtLink to="#">
              <img
                class="avatar"
                src="https://p3-passport.byteimg.com/img/user-avatar/a6c170c2f334370f08c6f8269c4f51cc~100x100.awebp"
                alt=""
              />
            </NuxtLink>
            <div class="author-info-box">
              <div class="author-name">
                <nuxt-link to="">
                  <span style="max-width: 128px" class="name">风度前端</span>
                </nuxt-link>
              </div>
              <div class="meta-box">
...
const { data, pending, error, refresh } = await useFetch(
  'http://localhost:1337/api/article-infos?populate=deep',
  {
    query: { populate: 'deep' },
    onResponse({ request, response, options }) {
      htmlValue.value = md2html(response._data.data[1].content)
